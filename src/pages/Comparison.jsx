...
const Comparison = () => {
  ...
  <div className="flex flex-col items-start">
    <h3 className="text-3xl font-medium max-w-[223px]">Go to Product page for more Products</h3>
    <span className="font-medium text-xl cursor-pointer text-[#727272] mt-[21px]">View More</span>
  </div>
  ...
  <div className="flex gap-[48px] mr-[76px]">
    ...
    <div className=" p-4 rounded-lg flex flex-col items-center">
      <img src="/images/first.png" alt="Asgaard Sofa" className="w-[280px] h-[177px] object-cover mb-2 rounded" />
